#!/usr/bin/env python3
"""
galaxy_mpi_visualscale.py

Representative large-scale galaxy GIF generator for the PA Project 2.
...
Run examples:
mpiexec -n 4 python galaxy_mpi_visualscale.py --represented-particles 100000000 --sample-particles 80000 --frames 30 --output-dir visual_1e8
mpiexec -n 4 python galaxy_mpi_visualscale.py --represented-particles 1000000000 --sample-particles 100000 --frames 30 --output-dir visual_1e9
"""
